  ...
  <div id="description">
    <h2>What is <span class='dodrio-text'><img class="icon is-rounded" src="PUBLIC_URL/figures/dodrio-logo.svg" style="height: 30px; width: 30px;" alt="Dodrio logo">&nbsp;Dodrio</span>?</h2>
      <p>
        ...
        Transformers now replace <a href="http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.676.4320&rep=rep1&type=pdf" title="Long Short-Term Memory">LSTMs</a> as the state-of-the-art model architecture for <a href="https://www.aclweb.org/anthology/W18-5446.pdf" title="GLUE NLP Benchmarks">NLP tasks</a>.
      </p>
      <p>
        We present <span class='dodrio-text'>Dodrio</span>, an interactive visualization tool to help NLP researchers and practitioners analyze and compare attention mechanisms with linguistic knowledge.
      </p>
    <h2>Why is <span class='dodrio-text'>Dodrio</span> useful?</h2>
    	<p>
    		In a large, pre-trained, high-performing model like <a href="https://www.aclweb.org/anthology/N19-1423.pdf" title="BERT">BERT</a>,
        ...
        These attention weights then make up an attention map at every attention head (a detailed explanation of this matrix calculation is available <a href="http://jalammar.github.io/illustrated-transformer/" title="Self-attention Calculation">here</a>).
        As every token in a sentence attends to every other token, we have 12 &times; 12 &times; number of tokens &times; number of tokens attention weights in BERT per text instance!
        ...
        Therefore, to more easily analyze attention weights, researchers need (1) <em>abstractions</em> and (2) <em>linguistic knowledge contexts</em>.
    	</p>
      <p>
        <span class='dodrio-text'>Dodrio</span> addresses the challenges of interpreting attention weights through an
        ...
        <img class="icon is-rounded" src="PUBLIC_URL/figures/edit.svg" alt="edit icon"> icon in the toolbar at the top of the interface.
      </p>
    ...
    <ol>
      ...
      <li><strong>Open the expanded <em>Attention Head Overview</em></strong> by clicking the <img class="is-rounded" style="height: 26px;" src="PUBLIC_URL/figures/article-overview-detail.png" alt="detail icon"/> button to see an detailed overview of attention heads.</li>
    	...
    	<li><strong>Filter dependency relations</strong> visualized by selecting the <img class="is-rounded" style="height: 26px;" src="PUBLIC_URL/figures/article-syntactic-rel-selection.png" alt="filter relations icon"/> icon in the upper toolbar.</li>
    </ol> 
    ...
    <p>
      <span class='dodrio-text'>Dodrio</span> visualizes Transformer data generated offline as detailed <a href="https://github.com/poloclub/dodrio/tree/master/data-generation">here</a>.
      Try visualizing your own model/dataset! The entire interactive system is written in
      Javascript using <a href="https://svelte.dev/"><em>Svelte</em></a> framework and <a href="https://d3js.org/"><em>D3.js</em></a> for visualizations.
      You only need a web browser to start exploring the attention mechanism in complex Transformers today!
      
      <span class='dodrio-text'>Dodrio</span> is an <a href="https://github.com/poloclub/dodrio">open-source project</a>;
      if you have any questions, feel free to open an issue <a href="https://github.com/poloclub/dodrio/issues">here</a>.

      To learn more about <span class='dodrio-text'>Dodrio</span>, please check out our pre-print paper <a href="https://arxiv.org/abs/2103.14625">"Dodrio: Exploring Transformer Models with Interactive Visualization."</a>
    </p>
    ...
    <p>
      ...
      This work was supported in part by NSF grants IIS-1563816, CNS-1704701, NASA NSTRF, DARPA GARD, gifts from Bosch, Intel, NVIDIA, Google, Amazon.
    </p>
  </div>
</body>